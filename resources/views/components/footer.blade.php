...
<footer id="footer" class="footer  pointer-events-none footer-horizontal footer-center text-base-content rounded p-10">
      <div class="absolute inset-0 pointer-events-none z-100 overflow-visible">
        ...
        <div class="absolute bottom-[5%] left-[5%] lg:left-[25%] w-10 lg:w-28 transform rotate-5 blocky-item">
            {!! file_get_contents(asset('svg/arrastra.svg')) !!}
        </div>

        <div class="absolute bottom-[5%] right-[5%] lg:right-[23%] w-10 lg:w-45 transform -rotate-5 blocky-item hidden sm:block">
            {!! file_get_contents(asset('svg/aprende.svg')) !!}
        </div>

        <div class="absolute bottom-[5%] right-[20%] lg:right-[38%] w-14  opacity-0  lg:w-30 transform -rotate-6 blocky-item">
            {!! file_get_contents(asset('svg/juega.svg')) !!}
        </div>

        <div class="absolute bottom-[5%] left-[15%] lg:left-[36%] w-14  opacity-0  lg:w-52 transform rotate-6 blocky-item">
